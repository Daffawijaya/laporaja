        ...
        <ContentGrid
          ...
          aside={
            <>
              <section aria-label="Info kegiatan" className="ref-card p-4 pb-6">
                ...
                <dl className="mt-2 divide-y divide-neutral-200/70 text-sm dark:divide-white/10">
                  <div className="flex gap-2 px-1 py-2.5">
                    <dt className="w-20 shrink-0 text-neutral-500">Pelapor</dt>
                    <dd className="min-w-0">
                      <p className="truncate font-medium">{ownerNama}</p>
                      <p className="text-xs text-neutral-500">{ownerUsername}</p>
                    </dd>
                  </div>
                  <div className="flex gap-2 px-1 py-2.5">
              ...
              <section aria-label="Review" className="ref-card p-4 pb-6">
